...
Whether you seek a peaceful escape, a family gathering, or a celebration with friends, Reef Villa provides the perfect setting with concierge service, daily maintenance, private parking, and secure perimeter access.`;

const DEFAULT_ABOUT_AR = `ريف فيلا هو شاليه فاخر يقع في قلب المشهد الطبيعي الخلّاب في سلطنة عمان. نمزج بين الراحة العصرية والتراث العماني الأصيل لنقدّم لضيوفنا تجربة إقامة لا تُنسى.
...
سواء كنت تبحث عن ملاذ هادئ، أو لمّة عائلية، أو احتفال مع الأصدقاء، يوفّر ريف فيلا المكان الأمثل مع خدمة الكونسيرج، والصيانة اليومية، ومواقف خاصة، ومحيط آمن.`;
    ...
    <div className="p-6 space-y-8 max-w-lg mx-auto pb-24">
      ...
      <section className="text-center space-y-2">
        ...
        <h2 className="font-headline text-3xl font-bold text-primary-navy">
          {isAr ? 'عن ريف فيلا' : 'About Reef Villa'}
        </h2>
      </section>
      ...
      <div className="bg-white rounded-[20px] p-6 border border-primary-navy/5 shadow-sm space-y-4">
        ...
        <div className="space-y-3 text-sm text-primary-navy/70">
          <div className="flex items-center gap-3">
            ...
            <span>{isAr ? 'ريف فيلا، ولاية الحمراء' : 'Reef Villa, Oman'}</span>
          </div>
          <div className="flex items-center gap-3">
